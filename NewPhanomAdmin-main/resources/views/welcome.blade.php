            ...
            <div class="col-xl-4 col-lg-5 col-md-6">
                <div class="card overflow-hidden text-center h-100 p-xxl-4 p-3 mb-0">
                    <a href="index.html" class="auth-brand mb-3">
                        <img src="assets/images/logo-sm.svg" alt="dark logo" height="60" class="logo-dark">
                        <img src="assets/images/logo-sm.svg" alt="logo light" height="60" class="logo-light">
                    </a>
                    ...
                    <form action="{{ url('/dashboard') }}" class="text-start mb-3">
                        @csrf
                        <div class="mb-3">
